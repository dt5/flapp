...
public class ArcballCamera extends Camera {
    ...
    //Declare some variables to determine which State the Arcball camera is in - Translate or Rotate
    private boolean mMode = true; // true - rotate/scale, false - DO NOTHING!
